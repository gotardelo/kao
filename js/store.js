/* ============================================================
   Kao — camada de dados + criptografia
...
(function (global) {
  ...
  function write(key, value) {
    try {
      ...
      console.error('[Kao] falha ao gravar', key, e);
      return false;
    }
  }
  function uid() {
  ...
  var Config = {
    ...
    get: function (uid_) { return Object.assign(Config.defaults(), read(K.config(uid_), {})); },
  ...
  var Usage = {
     ...
     */
    add: function (uid_, inTok, outTok, model, cache) {
      var u = Usage.tudo(uid_);
      var p = (global.Claude && Claude.priceOf(model)) || { in: 0, out: 0 };
  ...
  global.Store = {
    ...
    Profile: Profile, Persona: PersonaStore,
